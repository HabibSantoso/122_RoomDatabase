...
import com.example.roomsiswa_122.model.DetailViewModel
import com.example.roomsiswa_122.model.ItemDetailsUiState
import com.example.roomsiswa_122.model.PenyediaViewModel
import com.example.roomsiswa_122.model.toSiswa
...
fun DetailsScreen(
    ...
    val uiState = viewModel.uiSatate.collectAsState()
    val coroutineScope = rememberCoroutineScope()
    Scaffold(
        topBar = {
            SiswaTopAppBar(
                title = stringResource(id = R.string.titleRes),
